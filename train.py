...
def log_to_csv(epoch, train_loss, val_loss, val_acc, train_acc, output_dir):
    ...
    with open(csv_path, mode='a', newline='') as file:
        ...
        if not file_exists:
            writer.writerow(["epoch", "train_loss", "val_loss", "val_acc", "train_acc"])
        writer.writerow([epoch, train_loss, val_loss, val_acc, train_acc])
    
    #print("✅ CSV log saved for epoch", epoch)
...
def main():
    ...
    for epoch in range(args.max_epochs):
        ...
        # train
        train_loss, train_acc = train_one_epoch(model, train_dataloader, optimizer, fewshot_method, criterion, train_labels, epoch, args)
